...
\
  ...
  # Create instance: axi_smc_ctrl, and set properties
  set axi_smc_ctrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 axi_smc_ctrl ]
  set_property -dict [list \
    CONFIG.NUM_MI {1} \
    CONFIG.NUM_SI {1} \
  ] $axi_smc_ctrl
  ...
  # Create instance: axi_smc_mem, and set properties
  set axi_smc_mem [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 axi_smc_mem ]
  set_property -dict [list \
    CONFIG.NUM_MI {1} \
    CONFIG.NUM_SI {2} \
  ] $axi_smc_mem
  ...
  # Create instance: lenet_mnist_cap64_hls_0, and set properties
  set lenet_mnist_cap64_hls_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:lenet_mnist_cap64_hls:1.0 lenet_mnist_cap64_hls_0 ]

  # Create instance: lenet_dma_wrapper_0, and set properties
  set block_name lenet_dma_wrapper
  set block_cell_name lenet_dma_wrapper_0
  if { [catch {set lenet_dma_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $lenet_dma_wrapper_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins lenet_dma_wrapper_0/s_axis]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins axi_smc_mem/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins axi_smc_mem/S01_AXI]
  connect_bd_intf_net -intf_net axi_smc_ctrl_M00_AXI [get_bd_intf_pins axi_smc_ctrl/M00_AXI] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_smc_mem_M00_AXI [get_bd_intf_pins axi_smc_mem/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
  connect_bd_intf_net -intf_net lenet_dma_wrapper_0_m_axis [get_bd_intf_pins lenet_dma_wrapper_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD] [get_bd_intf_pins axi_smc_ctrl/S00_AXI]

  # Create port connections
  connect_bd_net -net lenet_dma_wrapper_0_accel_ap_start  [get_bd_pins lenet_dma_wrapper_0/accel_ap_start] \
  [get_bd_pins lenet_mnist_cap64_hls_0/ap_start]
  connect_bd_net -net lenet_dma_wrapper_0_accel_input_data  [get_bd_pins lenet_dma_wrapper_0/accel_input_data] \
  [get_bd_pins lenet_mnist_cap64_hls_0/input_layer_TDATA]
  connect_bd_net -net lenet_dma_wrapper_0_accel_input_valid  [get_bd_pins lenet_dma_wrapper_0/accel_input_valid] \
  [get_bd_pins lenet_mnist_cap64_hls_0/input_layer_TVALID]
  connect_bd_net -net lenet_dma_wrapper_0_accel_output_ready  [get_bd_pins lenet_dma_wrapper_0/accel_output_ready] \
  [get_bd_pins lenet_mnist_cap64_hls_0/layer13_out_TREADY]
  connect_bd_net -net lenet_mnist_cap64_hls_0_ap_done  [get_bd_pins lenet_mnist_cap64_hls_0/ap_done] \
  [get_bd_pins lenet_dma_wrapper_0/accel_ap_done]
  connect_bd_net -net lenet_mnist_cap64_hls_0_ap_idle  [get_bd_pins lenet_mnist_cap64_hls_0/ap_idle] \
  [get_bd_pins lenet_dma_wrapper_0/accel_ap_idle]
  connect_bd_net -net lenet_mnist_cap64_hls_0_ap_ready  [get_bd_pins lenet_mnist_cap64_hls_0/ap_ready] \
  [get_bd_pins lenet_dma_wrapper_0/accel_ap_ready]
  connect_bd_net -net lenet_mnist_cap64_hls_0_input_layer_TREADY  [get_bd_pins lenet_mnist_cap64_hls_0/input_layer_TREADY] \
  [get_bd_pins lenet_dma_wrapper_0/accel_input_ready]
  connect_bd_net -net lenet_mnist_cap64_hls_0_layer13_out_TDATA  [get_bd_pins lenet_mnist_cap64_hls_0/layer13_out_TDATA] \
  [get_bd_pins lenet_dma_wrapper_0/accel_output_data]
  connect_bd_net -net lenet_mnist_cap64_hls_0_layer13_out_TVALID  [get_bd_pins lenet_mnist_cap64_hls_0/layer13_out_TVALID] \
  [get_bd_pins lenet_dma_wrapper_0/accel_output_valid]
  connect_bd_net -net rst_ps8_0_100M_interconnect_aresetn  [get_bd_pins rst_ps8_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn  [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] \
  [get_bd_pins axi_dma_0/axi_resetn] \
  [get_bd_pins lenet_dma_wrapper_0/ap_rst_n] \
  [get_bd_pins lenet_mnist_cap64_hls_0/ap_rst_n] \
  ...
  [get_bd_pins lenet_dma_wrapper_0/ap_clk] \
  [get_bd_pins lenet_mnist_cap64_hls_0/ap_clk]
