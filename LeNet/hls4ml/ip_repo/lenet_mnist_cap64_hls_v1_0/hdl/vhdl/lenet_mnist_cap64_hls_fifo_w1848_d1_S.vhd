...
entity lenet_mnist_cap64_hls_fifo_w1848_d1_S is 
    generic (
        MEM_STYLE         : string  := "shiftReg";
        DATA_WIDTH        : integer := 1848;
...
architecture rtl of lenet_mnist_cap64_hls_fifo_w1848_d1_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component lenet_mnist_cap64_hls_fifo_w1848_d1_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1848;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 1);
...
begin
----------------------- Instantiation -----------------------
    U_lenet_mnist_cap64_hls_fifo_w1848_d1_S_ShiftReg : lenet_mnist_cap64_hls_fifo_w1848_d1_S_ShiftReg
    generic map (
...
entity lenet_mnist_cap64_hls_fifo_w1848_d1_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1848;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 1);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end lenet_mnist_cap64_hls_fifo_w1848_d1_S_ShiftReg;

architecture rtl of lenet_mnist_cap64_hls_fifo_w1848_d1_S_ShiftReg is
