...
entity lenet_mnist_cap64_hls_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity lenet_mnist_cap64_hls_regslice_both;

architecture behave of lenet_mnist_cap64_hls_regslice_both is
