...
module lenet_mnist_cap64_hls_hls_deadlock_idx0_monitor ( // for module lenet_mnist_cap64_hls_lenet_mnist_cap64_hls_inst
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[10] = idx2_block & (1'b0 | axis_block_sigs[1]);
