#!/usr/bin/env python3
"""Executa PTQ int8 pof2s da ResNet8 usando o Vitis AI Quantizer 3.5."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=ROOT / "reports/quantization.json",
    )
...
def main() -> None:
    ...
    images = calibration["images"].astype(np.float32) / 255.0
