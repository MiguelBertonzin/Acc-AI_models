#!/usr/bin/env python3
"""Empacota XModel, dataset, referência e scripts para a ZCU104."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=ROOT / "artifacts/deploy/resnet8_no_softmax_zcu104_vai3_5",
    )
...
def main() -> None:
    ...
    sources = {
        ROOT
        / "artifacts/compiled/resnet8_no_softmax_zcu104_vai3_5/resnet8_no_softmax.xmodel": "resnet8_no_softmax.xmodel",
        ROOT / "data/prepared/cifar10_test_uint8.npz": "cifar10_test_uint8.npz",
    ...
    if args.output_dir.exists() and any(args.output_dir.iterdir()):
        raise FileExistsError(
            f"{args.output_dir} não está vazio; preserve o pacote existente"
        )
