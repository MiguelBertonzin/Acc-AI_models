#!/usr/bin/env python3
"""Reproducible batch-1 GPU benchmark for the softmax ResNet-8 model.
...
DEFAULT_MODEL = PROJECT_ROOT / "resnet8_cifar10_keras3.h5"
...
def main() -> None:
    ...
    if activation != "softmax":
        raise ValueError(f"Expected the softmax model, found final activation {activation!r}")
