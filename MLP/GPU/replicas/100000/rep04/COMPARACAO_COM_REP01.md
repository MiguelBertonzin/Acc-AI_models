...
|---|---:|---:|---:|
| Inference-only — média | 0.185747 ms | 0.163588 ms | -11.93% |
| Inference-only — mediana | 0.160364 ms | 0.156341 ms | -2.51% |
| Inference-only — desvio-padrão | 0.065265 ms | 0.030366 ms | -53.47% |
| Inference-only — p95 | 0.318122 ms | 0.208693 ms | -34.40% |
| Inference-only — p99 | 0.448947 ms | 0.274215 ms | -38.92% |
| End-to-end — média efetiva | 0.280414 ms | 0.253019 ms | -9.77% |
| End-to-end — vazão efetiva | 3566.15 inf/s | 3952.27 inf/s | +10.83% |
| Potência média da placa | 28.520 W | 28.436 W | -0.29% |
| Energia total por inferência | 8.158457 mJ | 7.372779 mJ | -9.63% |
| Utilização média da GPU | 10.49 % | 8.88 % | -15.38% |
| Temperatura média | 45.42 °C | 49.00 °C | +7.89% |
...
|---|---:|---:|---:|---:|
| Inference-only | -22.158 µs | [-25.486, -18.830] µs | 2.066e-36 | -0.549 |
| End-to-end efetiva | -27.396 µs | [-30.998, -23.794] µs | 3.574e-46 | -0.618 |
...
|---|---:|
| Média | 0.163588 ms |
| IC95% da média | [0.162796, 0.164381] ms |
| Mediana | 0.156341 ms |
| Desvio-padrão | 0.030366 ms |
| CV | 18.56% |
| p90 / p95 / p99 | 0.184012 / 0.208693 / 0.274215 ms |
| Mínimo / máximo | 0.139396 / 2.122419 ms |
...
| Métrica | Resultado |
|---|---:|
| Média individual | 0.252019 ms |
| IC95% da média | [0.251064, 0.252974] ms |
| Mediana | 0.252443 ms |
| Desvio-padrão | 0.039878 ms |
| p90 / p95 / p99 | 0.277266 / 0.290939 / 0.371036 ms |
| Mínimo / máximo | 0.178176 / 3.223427 ms |
| Média efetiva pelas passagens | 0.253019 ms |
| Vazão efetiva | 3952.27 inferências/s |
...
| Métrica | Resultado |
|---|---:|
| Amostras durante benchmark | 256 |
| Janela energética | 25.927 s |
| Potência média / p95 / máxima | 28.436 / 28.670 / 28.690 W |
| Potência ociosa | 28.367 W |
| Energia total | 737.278 J |
| Energia total por inferência | 7.372779 mJ |
| Energia dinâmica por inferência | 0.017958 mJ |
| Utilização GPU média / p95 / máxima | 8.88% / 11.00% / 11.00% |
| Memória usada média / máxima | 700.0 / 700.0 MiB |
| Clock SM médio / máximo | 1755.0 / 1755.0 MHz |
| Temperatura média / máxima | 49.0 / 49.0 °C |
