...
| Métrica | Resultado |
|---|---:|
| Latência média | 0.174547 ms |
| IC95% da latência média | [0.172302, 0.176791] ms |
| Mediana | 0.157338 ms |
| Desvio-padrão | 0.047602 ms |
| p95 / p99 | 0.270614 / 0.383610 ms |
| Mínimo / máximo | 0.134981 / 1.269788 ms |
| Vazão média por ciclo | 4068.07 inferências/s |
| Vazão efetiva global | 3958.98 inferências/s |
| Potência média da placa | 29.239 W |
| Potência ociosa após aquecimento | 29.274 W |
| Potência dinâmica média estimada | 0.000 W |
| Energia total da campanha | 226.295 J |
| Energia dinâmica da campanha | 0.000 J |
| Energia total por inferência | 7.543039 mJ |
| Energia dinâmica por inferência | 0.000000 mJ |
| Utilização GPU média / máxima | 11.24% / 13.00% |
...
| Temperatura média / máxima | 57.0 / 57.0 °C |
| Ventoinha média / máxima | 31.0% / 31.0% |
| P-state observado | P2: 76 |
| Telemetria | 76 amostras em 7.740 s |
