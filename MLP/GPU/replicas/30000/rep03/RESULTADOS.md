...
| Métrica | Resultado |
|---|---:|
| Latência média | 0.169919 ms |
| IC95% da latência média | [0.168697, 0.171142] ms |
| Mediana | 0.159967 ms |
| Desvio-padrão | 0.034606 ms |
| p95 / p99 | 0.230314 / 0.307971 ms |
| Mínimo / máximo | 0.138972 / 1.814921 ms |
| Vazão média por ciclo | 3906.10 inferências/s |
| Vazão efetiva global | 3864.81 inferências/s |
| Potência média da placa | 29.344 W |
| Potência ociosa após aquecimento | 29.509 W |
| Potência dinâmica média estimada | 0.000 W |
| Energia total da campanha | 232.337 J |
| Energia dinâmica da campanha | 0.000 J |
| Energia total por inferência | 7.744421 mJ |
| Energia dinâmica por inferência | 0.000000 mJ |
| Utilização GPU média / máxima | 11.32% / 13.00% |
...
| Temperatura média / máxima | 59.4 / 60.0 °C |
| Ventoinha média / máxima | 32.0% / 32.0% |
| P-state observado | P2: 78 |
| Telemetria | 78 amostras em 7.918 s |
