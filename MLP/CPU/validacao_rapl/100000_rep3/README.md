...
|---|---:|
| Inference-only média | 0.113392 ms |
| Inference-only IC95% | [0.112832, 0.113946] ms |
| Inference-only mediana | 0.105913 ms |
| Inference-only p95 / p99 | 0.154721 / 0.224631 ms |
| Inference-only mínimo / máximo | 0.094130 / 2.177524 ms |
| End-to-end média individual | 0.137521 ms |
| End-to-end IC95% | [0.136835, 0.138197] ms |
| End-to-end mediana | 0.127953 ms |
| End-to-end p95 / p99 | 0.193670 / 0.276995 ms |
| End-to-end média efetiva | 0.138320 ms |
| Vazão efetiva | 7229.62 inferências/s |

## Telemetria CPU

| Métrica | Resultado |
|---|---:|
| Amostras durante benchmark | 144 |
| Utilização do processo média / máxima | 111.17% / 130.40% |
| Núcleos lógicos equivalentes médios | 1.112 |
| Utilização global média / máxima | 5.57% / 8.80% |
| Frequência média / p95 / máxima | 2139.2 / 2700.6 / 3669.5 MHz |
| Temperatura do pacote média / máxima | 76.6 / 82.0 °C |
| RSS do processo média / máxima | 725.0 / 726.6 MiB |
| Fan média / máxima | 1041 / 1100 RPM |
...
| Duração exata da janela RAPL | 14.464128485 s |
| Energia total do pacote | 844.346044 J |
| Potência média do pacote | 58.375176 W |
| Potência ociosa do pacote | 14.282781 W |
| Energia total por inferência | 8.443460 mJ |
| Potência dinâmica média | 44.092395 W |
| Energia dinâmica por inferência | 6.377581 mJ |
| Energia dos núcleos | 712.717170 J |
| Potência média dos núcleos | 49.274809 W |
