...
|---|---:|
| Inference-only média | 0.112612 ms |
| Inference-only IC95% | [0.111236, 0.113989] ms |
| Inference-only mediana | 0.103548 ms |
| Inference-only p95 / p99 | 0.157879 / 0.260939 ms |
| Inference-only mínimo / máximo | 0.093425 / 0.921949 ms |
| End-to-end média individual | 0.136371 ms |
| End-to-end IC95% | [0.134675, 0.138067] ms |
| End-to-end mediana | 0.124858 ms |
| End-to-end p95 / p99 | 0.197375 / 0.315715 ms |
| End-to-end média efetiva | 0.137186 ms |
| Vazão efetiva | 7289.40 inferências/s |
...
| Utilização do processo média / máxima | 110.41% / 119.80% |
| Núcleos lógicos equivalentes médios | 1.104 |
| Utilização global média / máxima | 5.15% / 7.90% |
| Frequência média / p95 / máxima | 1833.7 / 2186.9 / 2622.7 MHz |
| Temperatura do pacote média / máxima | 69.1 / 73.0 °C |
| RSS do processo média / máxima | 723.3 / 723.7 MiB |
| Fan média / máxima | 917 / 917 RPM |
...
| Duração exata da janela RAPL | 4.301619475 s |
| Energia total do pacote | 226.698822 J |
| Potência média do pacote | 52.700808 W |
| Potência ociosa do pacote | 11.425576 W |
| Energia total por inferência | 7.556627 mJ |
| Potência dinâmica média | 41.275232 W |
| Energia dinâmica por inferência | 5.918345 mJ |
| Energia dos núcleos | 189.422733 J |
| Potência média dos núcleos | 44.035214 W |
