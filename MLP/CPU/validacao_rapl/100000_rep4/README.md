...
|---|---:|
| Inference-only média | 0.109510 ms |
| Inference-only IC95% | [0.109163, 0.109853] ms |
| Inference-only mediana | 0.104323 ms |
| Inference-only p95 / p99 | 0.137230 / 0.181795 ms |
| Inference-only mínimo / máximo | 0.094338 / 1.114697 ms |
| End-to-end média individual | 0.132771 ms |
| End-to-end IC95% | [0.132347, 0.133191] ms |
| End-to-end mediana | 0.126045 ms |
| End-to-end p95 / p99 | 0.167908 / 0.226342 ms |
| End-to-end média efetiva | 0.133577 ms |
| Vazão efetiva | 7486.30 inferências/s |
...
| Utilização do processo média / máxima | 111.29% / 120.70% |
| Núcleos lógicos equivalentes médios | 1.113 |
| Utilização global média / máxima | 5.07% / 8.90% |
| Frequência média / p95 / máxima | 1963.7 / 2330.9 / 2530.9 MHz |
| Temperatura do pacote média / máxima | 70.5 / 73.0 °C |
| RSS do processo média / máxima | 724.7 / 726.2 MiB |
| Fan média / máxima | 907 / 909 RPM |
...
| Duração exata da janela RAPL | 13.965082243 s |
| Energia total do pacote | 711.034191 J |
| Potência média do pacote | 50.915145 W |
| Potência ociosa do pacote | 11.475549 W |
| Energia total por inferência | 7.110342 mJ |
| Potência dinâmica média | 39.439596 W |
| Energia dinâmica por inferência | 5.507772 mJ |
| Energia dos núcleos | 589.429949 J |
| Potência média dos núcleos | 42.207410 W |
