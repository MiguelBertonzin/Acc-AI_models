...
|---|---:|
| Inference-only média | 0.113360 ms |
| Inference-only IC95% | [0.111991, 0.114729] ms |
| Inference-only mediana | 0.104898 ms |
| Inference-only p95 / p99 | 0.155904 / 0.259424 ms |
| Inference-only mínimo / máximo | 0.094790 / 1.019469 ms |
| End-to-end média individual | 0.137184 ms |
| End-to-end IC95% | [0.135502, 0.138867] ms |
| End-to-end mediana | 0.126497 ms |
| End-to-end p95 / p99 | 0.195184 / 0.312709 ms |
| End-to-end média efetiva | 0.137990 ms |
| Vazão efetiva | 7246.92 inferências/s |

## Telemetria CPU

| Métrica | Resultado |
|---|---:|
| Amostras durante benchmark | 44 |
| Utilização do processo média / máxima | 108.68% / 123.60% |
| Núcleos lógicos equivalentes médios | 1.087 |
| Utilização global média / máxima | 5.15% / 8.80% |
| Frequência média / p95 / máxima | 1899.8 / 2292.5 / 2459.0 MHz |
| Temperatura do pacote média / máxima | 70.9 / 75.0 °C |
| RSS do processo média / máxima | 723.9 / 724.2 MiB |
| Fan média / máxima | 911 / 911 RPM |
...
| Duração exata da janela RAPL | 4.326595895 s |
| Energia total do pacote | 229.755393 J |
| Potência média do pacote | 53.103040 W |
| Potência ociosa do pacote | 11.587561 W |
| Energia total por inferência | 7.658513 mJ |
| Potência dinâmica média | 41.515478 W |
| Energia dinâmica por inferência | 5.987357 mJ |
| Energia dos núcleos | 191.609068 J |
| Potência média dos núcleos | 44.286333 W |
