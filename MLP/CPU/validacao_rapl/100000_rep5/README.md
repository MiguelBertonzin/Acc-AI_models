...
|---|---:|
| Inference-only média | 0.109670 ms |
| Inference-only IC95% | [0.109284, 0.110053] ms |
| Inference-only mediana | 0.104232 ms |
| Inference-only p95 / p99 | 0.143795 / 0.184650 ms |
| Inference-only mínimo / máximo | 0.093061 / 1.248128 ms |
| End-to-end média individual | 0.132959 ms |
| End-to-end IC95% | [0.132494, 0.133422] ms |
| End-to-end mediana | 0.125941 ms |
| End-to-end p95 / p99 | 0.176496 / 0.229084 ms |
| End-to-end média efetiva | 0.133748 ms |
| Vazão efetiva | 7476.75 inferências/s |

## Telemetria CPU

| Métrica | Resultado |
|---|---:|
| Amostras durante benchmark | 139 |
| Utilização do processo média / máxima | 111.20% / 121.70% |
| Núcleos lógicos equivalentes médios | 1.112 |
| Utilização global média / máxima | 5.05% / 6.20% |
| Frequência média / p95 / máxima | 1813.2 / 2209.9 / 2420.1 MHz |
| Temperatura do pacote média / máxima | 71.4 / 77.0 °C |
| RSS do processo média / máxima | 725.3 / 726.8 MiB |
| Fan média / máxima | 916 / 917 RPM |
...
| Duração exata da janela RAPL | 13.978587436 s |
| Energia total do pacote | 733.045791 J |
| Potência média do pacote | 52.440620 W |
| Potência ociosa do pacote | 11.096390 W |
| Energia total por inferência | 7.330458 mJ |
| Potência dinâmica média | 41.344230 W |
| Energia dinâmica por inferência | 5.779339 mJ |
| Energia dos núcleos | 610.308435 J |
| Potência média dos núcleos | 43.660237 W |
