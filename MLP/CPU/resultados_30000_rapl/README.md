...
|---|---:|
| Inference-only média | 0.115357 ms |
| Inference-only IC95% | [0.114215, 0.116499] ms |
| Inference-only mediana | 0.106364 ms |
| Inference-only p95 / p99 | 0.162879 / 0.248020 ms |
| Inference-only mínimo / máximo | 0.094664 / 1.003731 ms |
| End-to-end média individual | 0.139764 ms |
| End-to-end IC95% | [0.138368, 0.141160] ms |
| End-to-end mediana | 0.128626 ms |
| End-to-end p95 / p99 | 0.203374 / 0.297983 ms |
| End-to-end média efetiva | 0.140597 ms |
| Vazão efetiva | 7112.53 inferências/s |
...
| Utilização do processo média / máxima | 111.45% / 127.20% |
| Núcleos lógicos equivalentes médios | 1.115 |
| Utilização global média / máxima | 5.89% / 8.30% |
| Frequência média / p95 / máxima | 2258.7 / 2588.3 / 2969.5 MHz |
| Temperatura do pacote média / máxima | 66.5 / 77.0 °C |
| RSS do processo média / máxima | 723.6 / 724.0 MiB |
| Fan média / máxima | 920 / 920 RPM |
...
| Duração exata da janela RAPL | 4.411500140 s |
| Energia total do pacote | 253.270713 J |
| Potência média do pacote | 57.411471 W |
| Potência ociosa do pacote | 13.486750 W |
| Energia total por inferência | 8.442357 mJ |
| Potência dinâmica média | 43.924721 W |
| Energia dinâmica por inferência | 6.459130 mJ |
| Energia dos núcleos | 214.072389 J |
| Potência média dos núcleos | 48.525985 W |
