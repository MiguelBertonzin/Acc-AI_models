...
|---|---:|
| Inference-only média | 0.118547 ms |
| Inference-only IC95% | [0.117846, 0.119242] ms |
| Inference-only mediana | 0.108445 ms |
| Inference-only p95 / p99 | 0.168899 / 0.264964 ms |
| Inference-only mínimo / máximo | 0.095008 / 1.467375 ms |
| End-to-end média individual | 0.143629 ms |
| End-to-end IC95% | [0.142773, 0.144479] ms |
| End-to-end mediana | 0.131169 ms |
| End-to-end p95 / p99 | 0.208811 / 0.317863 ms |
| End-to-end média efetiva | 0.144457 ms |
| Vazão efetiva | 6922.47 inferências/s |

## Telemetria CPU

| Métrica | Resultado |
|---|---:|
| Amostras durante benchmark | 150 |
| Utilização do processo média / máxima | 111.17% / 125.80% |
| Núcleos lógicos equivalentes médios | 1.112 |
| Utilização global média / máxima | 6.15% / 12.50% |
| Frequência média / p95 / máxima | 2321.8 / 2711.5 / 2970.9 MHz |
| Temperatura do pacote média / máxima | 75.5 / 82.0 °C |
| RSS do processo média / máxima | 724.7 / 726.3 MiB |
| Fan média / máxima | 920 / 940 RPM |
...
| Duração exata da janela RAPL | 15.074058879 s |
| Energia total do pacote | 909.804983 J |
| Potência média do pacote | 60.355674 W |
| Potência ociosa do pacote | 14.247820 W |
| Energia total por inferência | 9.098050 mJ |
| Potência dinâmica média | 46.107854 W |
| Energia dinâmica por inferência | 6.950325 mJ |
| Energia dos núcleos | 771.938758 J |
| Potência média dos núcleos | 51.209748 W |
